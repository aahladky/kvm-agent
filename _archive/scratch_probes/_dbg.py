...
ag.reset()
ag.actions=["Click 7","Click x","Click 8"]; ag.responses=[RESP_8]; ag.screenshots=[process_image(open(PREV,"rb").read(),factor=32)[0]]
resp,codes=ag.predict("Using the open Calculator, compute 7 x 8 + 5",{"screenshot":open(CUR,"rb").read()})
print("RAW RESPONSE:\n",resp)
print("CODES:",codes)
