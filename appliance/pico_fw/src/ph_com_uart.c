...
// Wired to match this rig's physical wiring (appliance/README.md): Pi5 GPIO14(TX)->Pico
// GP1(RX), Pi5 GPIO15(RX)<-Pico GP0(TX) -- GP0/GP1 is uart0 on both RP2040 and RP2350.
#define _BUS		uart0
